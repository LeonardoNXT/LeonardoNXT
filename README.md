...
## 🚀 **Sobre Mim**  
- 💻 Desenvolvedor Full Stack com foco em **React**, **Node.js** e tecnologias modernas.  
- 🌱 Apaixonado por projetos que unem **tecnologia** e **sustentabilidade**.  
- 🎓 Atualmente finalizando meu TCC com o projeto **NewArch**, uma estação inteligente para monitoramento ambiental.  
